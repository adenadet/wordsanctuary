...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Service Detail for {{branch.name}} on {{service.date | excelDate}}</h3>
    </div>
    <div class="card-body">
        <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-sm-3">
                        <div class="info-box bg-light">
                            ...
                            <span class="info-box-number text-center text-muted mb-0">130</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-3">
                        <div class="info-box bg-light">
                            <div class="info-box-content">
                            <span class="info-box-text text-center text-muted">Total Offering</span>
                    ...
                    <div class="col-12 col-sm-3">
                        <div class="info-box bg-light">
                            <div class="info-box-content">
                            <span class="info-box-text text-center text-muted">Total Tithe</span>
                            <span class="info-box-number text-center text-muted mb-0">20,000 <span>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-3">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="post">
                            ...
                            <p><a href="#" class="link-black text-sm"><i class="fas fa-link mr-1"></i> Demo File 1 v2</a></p>
                        </div>
                        ...
                        <div class="post clearfix">
                            ...
                            <p>Lorem ipsum represents a long-held tradition for designers, typographers and the like. Some people hate it and argue for its demise, but others ignore.</p>
                            <p><a href="#" class="link-black text-sm"><i class="fas fa-link mr-1"></i> Demo File 2</a></p>
                        </div>
                        ...
                        <div class="post">
                            ...
                            <p>Lorem ipsum represents a long-held tradition for designers, typographers and the like. Some people hate it and argue for its demise, but others ignore.</p>
                            <p><a href="#" class="link-black text-sm"><i class="fas fa-link mr-1"></i> Demo File 1 v1</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2">
            ...
            <div class="text-muted">
                <p class="text-sm">Client Company<b class="d-block">Deveint Inc</b></p>
...
export default {
    ...
    methods:{
        getInitials(){
            axios.get('/api/service_reports/'+this.$route.params.id+'&date='+this.$route.params.date).then(response =>{
